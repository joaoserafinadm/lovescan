...
export default function Credits() {
  ...
  const filteredProducts = PRODUCTS.filter(
    (product) => activeTab === "all" || product.userType === activeTab
  );

  return (
    <div
      className="container fadeItem py-5"
        ...
        <div className="col-md-10">
          <div className="text-center mb-5">
            <img
              src="/LOGO_01.png"
              alt=""
              style={{ maxWidth: "370px", maxHeight: "100px" }}
            />
            ...
            <div className="col-md-6">
              <div className="card bg-dark border-0 h-100 shadow">
                <div className="card-body p-4">
                  <h3 className="mb-3" style={{ color: "#ff2056" }}>
                    Como funciona
                  </h3>
                  ...
                  <div className="d-flex mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-secondary">
                        Personalize uma apresentação romântica única
                      </p>
                    </div>
                  </div>
                  <div className="d-flex">
                    ...
                    <div>
                      ...
                      <p className="text-secondary">
                        Surpreenda com uma experiência digital inesquecível
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="card bg-dark border-0 h-100 shadow">
                <div className="card-body p-4">
                  ...
                  <p className="text-light">
                    Surpreenda seus clientes com uma experiência digital única e
                    memorável!
                  </p>
                  <div className="mt-3">
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <p className="mb-0 text-light">
                        <strong>Floriculturas:</strong>{" "}
                        <span className="text-secondary">
                          Anexe aos buquês de flores
                        </span>
                      </p>
                    </div>
                    <div className="d-flex align-items-center mb-3">
                      ...
                      ></i>
                      <p className="mb-0 text-light">
                        <strong>Joalherias:</strong>{" "}
                        <span className="text-secondary">
                          Complemente presentes especiais
                        </span>
                      </p>
                    </div>
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <p className="mb-0 text-light">
                        ...
                        <span className="text-secondary">
                          Grave em copos térmicos ou itens personalizados
                        </span>
                      </p>
                    </div>
                    <div className="d-flex align-items-center">
                      ...
                      <p className="mb-0 text-light">
                        ...
                        <span className="text-secondary">
                          Casamentos, aniversários, comemorações
                        </span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div key={product.id} className="col-md-6 col-lg-3 mb-4">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow:
                          selectedProduct?.id === product.id
                            ? "0 10px 20px rgba(255, 32, 86, 0.2)"
                    ...
                    >
                      ...
                      <div className="card-body d-flex flex-column p-4">
                        ...
                        <h4 className="card-title text-center text-light mb-2">
                          {product.title}
                        </h4>
                    ...
                    <div className="card bg-black border-0 h-100">
                      <div className="card-body p-4">
                        ...
                        <div className="d-flex align-items-center mb-3">
                          ...
                          <p className="mb-0 text-light">
                            Criar uma apresentação romântica personalizada
                          </p>
                        </div>
                        ...
                        <div className="d-flex align-items-center mb-3">
                          ...
                          <p className="mb-0 text-light">
                            Gerar um QR code único para acessar
                          </p>
                        </div>
                        ...
                        <div className="d-flex align-items-center mb-3">
                          ...
                          <p className="mb-0 text-light">
                            Transmitir seus sentimentos de forma digital
                          </p>
                        </div>
                        ...
                        {selectedProduct.credits > 1 && (
                          ...
                          >
                            <p
                              ...
                              style={{ color: "#ff2056", fontSize: "0.9rem" }}
                            >
                              <i className="fas fa-info-circle me-2"></i>
                              Ideal para empresas que desejam oferecer uma
                              experiência única aos seus clientes!
                            </p>
                          </div>
                        )}
                      </div>
          ...
          <div className="text-center text-secondary">
            <p>
              <small>
                Ao finalizar a compra, você concorda com nossos termos e
                condições.
              </small>
            </p>
          </div>
