...
import { Check, ChevronLeft, Copy, Share, Share2, TriangleAlert } from "lucide-react";
...
import { unmaskCelular } from "@/utils/maks";
...
export default function client() {
  ...
  const handleSendForm = async () => {
    const link = `https://www.lovescan.app/clientForm/${presentationData?._id}`;
            ...
            <div className="card-body">
              ...
              <div className="row my-3 my-md-5">
                {presentationData?.status === "active" ? (
                  <div className="col-12 d-flex align-items-center flex-column text-center justify-content-center">
                    <QrCodeGenerator
                  ...
                  <div className="col-12  d-flex align-items-center flex-column text-center justify-content-center">
                    <Button
                      ...
                      loading={loadingSave}
                      disabled={presentationData.status !== "pending"}
                    ...
                    {!presentationData.status && (
                      <span className="text-c-danger d-flex align-items-center">
                        <TriangleAlert className="me-2" /> Atenção! o formulário
                    ...
                    <div className="col-12 col-md-6">
                      <div className="mb-3">
                        ...
                        <div className="col-12 mt-2">
                          ...
                          {presentationData?.status === "pending" && (
                          ...
                          {presentationData?.status === "paused" && (
                      ...
                      <div className="mb-3">
                        ...
                        <p>{presentationData?.clientName}</p>
                      </div>

                      <div className="mb-3">
                        <strong className="me-2">Contato:</strong> <br />
                        {presentationData?.clientPhone ? (
                          <a
                            href={`https://wa.me/${unmaskCelular(presentationData?.clientPhone)}`}
                            target="_blank"
                            className="badge bg-light rounded-pill text-dark small  cardAnimation"
                          >
                            <div className="d-flex align-items-center">
                              {presentationData?.clientPhone}{" "}
                              <span
                                className="ms-2 cardAnimation"
                                type="button"
                              >
                                <svg
                          ...
                          <span className="badge bg-secondary rounded-pill text-white small">
