...
const ImageUploadWithEffect = ({ children, ...props }) => {
  ...
  const MAX_DESCRIPTION_LENGTH = 40; // Limite de caracteres para descrição
          ...
          {!noDescription && (
            <div className="mt-2">
              ...
              <div className="d-flex justify-content-between align-items-center mt-1">
                <small className={`text-muted ${remainingChars < 10 ? 'text-warning' : ''} ${remainingChars === 0 ? 'text-danger' : ''}`}>
                  {remainingChars > 0 
